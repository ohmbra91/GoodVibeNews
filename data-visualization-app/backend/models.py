...
class Article(Base):
    ...
    def __repr__(self):
        return f"<Article(agency={self.agency}, section={self.section}, author={self.author}, date={self.date}, headline={self.headline}, link={self.link}, is_political={self.is_political}, sentiment_score={self.sentiment_score}, image_url={self.image_url})>"